if(Battle_GetMenu()=3){
		...
		Anim_Create(id,"headx",0,0,320-1.6,100,15)
		Anim_Create(id,"bodyx",0,0,320-1.6,100,15)
		Anim_Create(id,"legsx",0,0,320,100,15)
		Anim_Create(head,"x",0,0,head.x,100,15)
		Anim_Create(body,"x",0,0,body.x,100,15)
		Anim_Create(legs,"x",0,0,legs.x,100,15)
		Anim_Create(id,"x",0,0,400,-100,15,40)
		Anim_Create(id,"headx",0,0,320-1.6+100,-100,15,40)
		Anim_Create(id,"bodyx",0,0,320-1.6+100,-100,15,40)
		Anim_Create(id,"legsx",0,0,320+100,-100,15,40)
		...
		Anim_Create(body,"x",0,0,body.x,-100,15)
		Anim_Create(legs,"x",0,0,legs.x,-100,15)
		Anim_Create(id,"x",0,0,240,100,15,40)
		Anim_Create(id,"headx",0,0,320-1.6-100,100,15,40)
		Anim_Create(id,"bodyx",0,0,320-1.6-100,100,15,40)
		Anim_Create(id,"legsx",0,0,320-100,100,15,40)
		Anim_Create(head,"x",0,0,head.x-100,100,15,40)
