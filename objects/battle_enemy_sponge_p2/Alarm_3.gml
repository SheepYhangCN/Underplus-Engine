...
menuspatula=Battle_MakeFriendlyPellet_Old(0,0,battle_soul.x-lengthdir_x(114514,angle),battle_soul.y-lengthdir_y(114514,angle),0,35,20,angle+90,1,true,battle_bullet_friendlypellet_old,spr_spatula)
