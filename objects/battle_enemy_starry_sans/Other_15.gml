switch(Battle_GetMenuChoiceButton()){
	case 1:
		switch(Battle_GetMenuChoiceAction()){
			...
			case 1:
			if(global.language=0){
			Dialog_Add("* You taunted Sans, {sleep 15}said everything&  he did are meaningless.{sleep 15}&  He will turn to dust at last.{pause}{clear}* Sans ignored.");
			}else if(global.language=1){
			Dialog_Add("* 你嘲讽Sans，{sleep 15}&  说他所做的所有事情都没有用。{sleep 15}&  他终将化为尘埃。{pause}{clear}* Sans没有理会。");
			}
			break;
}}