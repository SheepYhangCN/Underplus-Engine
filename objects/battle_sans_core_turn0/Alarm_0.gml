...
var _x=battle_soul.x+lengthdir_x(120,_angle)
var _y=battle_soul.y+lengthdir_y(120,_angle)
...
_x=battle_soul.x+lengthdir_x(120,_angle)
_y=battle_soul.y+lengthdir_y(120,_angle)
Battle_MakeBlaster(_xstart,_ystart,_x,_y,_angle-90,_angle-90,20,1,2,20,20,0)}
alarm[0]=80
}else{
