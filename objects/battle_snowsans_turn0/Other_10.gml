...
_dialog.text="{font 3}{speed 5}{scale 1}{voice 3}{titr_face 3}今天是多么悲伤的一天啊。{pause}{clear}{titr_face 1}鸟儿在哭泣, {sleep 20}&花儿在凋谢。{pause}{clear}{titr_face 0}在这样的一天里, {sleep 20}&{titr_face 3}像我这样的怪物, {pause}{clear}{skippable false}{black_cut 20}{titr_face 4}{audio_stop `bgm_bird`}{sleep 20}{skippable true}{font 2}再也不能视而不见了。"
}