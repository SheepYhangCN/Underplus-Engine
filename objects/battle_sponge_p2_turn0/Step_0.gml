...
switch timer{
case 120:
	var a=Battle_MakeFriendlyPellet(-32,battle_board.y-48,114514,battle_board.y-48,0,780,15,-90,1,true,battle_bullet_friendlypellet,spr_spatula)
	Anim_Create(a,"x",ANIM_TWEEN.BACK,ANIM_EASE.OUT,-32,128,10)
	break
case 220:
	var a=Battle_MakeFriendlyPellet(-32,battle_board.y+48,114514,battle_board.y+48,0,680,15,-90,1,true,battle_bullet_friendlypellet,spr_spatula)
	Anim_Create(a,"x",ANIM_TWEEN.BACK,ANIM_EASE.OUT,-32,128,10)
	break
case 320:
	var a=Battle_MakeFriendlyPellet(room_width+32,battle_board.y,-114514,battle_board.y,0,580,15,90,1,true,battle_bullet_friendlypellet,spr_spatula)
	Anim_Create(a,"x",ANIM_TWEEN.BACK,ANIM_EASE.OUT,room_width+32,-128,10)
	break
case 420:
	var a=Battle_MakeFriendlyPellet(battle_board.x-48,room_height+32,battle_board.x-48,-114514,0,480,15,0,1,true,battle_bullet_friendlypellet,spr_spatula)
	Anim_Create(a,"y",ANIM_TWEEN.BACK,ANIM_EASE.OUT,room_height+32,-80,10)
	var a=Battle_MakeFriendlyPellet(battle_board.x+48,room_height+32,battle_board.x+48,-114514,0,480,15,0,1,true,battle_bullet_friendlypellet,spr_spatula)
	Anim_Create(a,"y",ANIM_TWEEN.BACK,ANIM_EASE.OUT,room_height+32,-80,10)
	break
case 520:
	var a=Battle_MakeFriendlyPellet(battle_board.x,-32,battle_board.x,114514,0,380,15,180,1,true,battle_bullet_friendlypellet,spr_spatula)
	Anim_Create(a,"y",ANIM_TWEEN.BACK,ANIM_EASE.OUT,-32,72,10)
	break
case 620:
	var a=Battle_MakeFriendlyPellet(-32,-32,battle_board.x+96+114514,battle_board.y+96+114514,0,300,15,-135,1,true,battle_bullet_friendlypellet,spr_spatula)
	...
	var a=Battle_MakeFriendlyPellet(-32,room_height+32,battle_board.x+96+114514,battle_board.y-96-114514,0,300,15,-45,1,true,battle_bullet_friendlypellet,spr_spatula)
	Anim_Create(a,"x",ANIM_TWEEN.BACK,ANIM_EASE.OUT,-32,battle_board.x-96+32,10)
	Anim_Create(a,"y",ANIM_TWEEN.BACK,ANIM_EASE.OUT,room_height+32,battle_board.y+96-(room_height+32),10)
	var a=Battle_MakeFriendlyPellet(room_width+32,-32,battle_board.x-96-114514,battle_board.y+96+114514,0,300,15,135,1,true,battle_bullet_friendlypellet,spr_spatula)
	Anim_Create(a,"x",ANIM_TWEEN.BACK,ANIM_EASE.OUT,room_width+32,battle_board.x+96-(room_width+32),10)
	Anim_Create(a,"y",ANIM_TWEEN.BACK,ANIM_EASE.OUT,-32,battle_board.y-96+32,10)
	var a=Battle_MakeFriendlyPellet(room_width+32,room_height+32,battle_board.x-96-114514,battle_board.y-96-114514,0,300,15,45,1,true,battle_bullet_friendlypellet,spr_spatula)
	Anim_Create(a,"x",ANIM_TWEEN.BACK,ANIM_EASE.OUT,room_width+32,battle_board.x+96-(room_width+32),10)
	Anim_Create(a,"y",ANIM_TWEEN.BACK,ANIM_EASE.OUT,room_height+32,battle_board.y+96-(room_height+32),10)
	break
case 720:
...
case 1200:
	...
	break
case 1210:
	var a=Battle_MakeFriendlyPellet(-32,battle_soul.y,114514,battle_soul.y,0,20,10,-90,0,true,battle_bullet_friendlypellet,spr_spatula)
	var a=Battle_MakeFriendlyPellet(battle_soul.x,-32,battle_soul.x,114514,0,20,10,180,0,true,battle_bullet_friendlypellet,spr_spatula)
	break
case 1230:
	var a=Battle_MakeFriendlyPellet(-32,battle_soul.y,114514,battle_soul.y,0,20,10,-90,0,true,battle_bullet_friendlypellet,spr_spatula)
	var a=Battle_MakeFriendlyPellet(battle_soul.x,-32,battle_soul.x,114514,0,20,10,180,0,true,battle_bullet_friendlypellet,spr_spatula)
