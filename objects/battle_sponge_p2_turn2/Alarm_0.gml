...
var a=Battle_MakeFriendlyPellet(0,0,battle_soul.x-lengthdir_x(114514,angle+45),battle_soul.y-lengthdir_y(114514,angle+45),0,35,20,angle+135,1,true,battle_bullet_friendlypellet,spr_spatula)
