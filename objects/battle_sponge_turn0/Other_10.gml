...
_dialog.text="{font 3}{scale 1}{voice 8}今天是多么美好的&一天啊...{pause}{clear}{sponge_face 3}海藻在飘摇，{sleep 15}&水母在游弋...{pause}{clear}在这样的一天里，{sleep 15}{sponge_face 1}&像你这样的浮游生物...{pause}{clear}{skippable false}{black_cut 20}{sponge_face 4}{sleep 20}{skippable true}{font 2}{color `red`}应当在荷兰人的柜子&里度过余生。"
}