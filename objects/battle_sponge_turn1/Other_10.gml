...
_dialog.text="{font 3}{scale 1}{voice VOICE.SPONGE}{sponge_face 1}What?&{sleep 15}You really think that&only you can dodge?"
}else if(global.language=LANGUAGE.SCHINESE){
_dialog.text="{font 3}{scale 1}{voice VOICE.SPONGE}{sponge_face 1}怎么? &{sleep 15}你真以为只有你能躲避? "
}