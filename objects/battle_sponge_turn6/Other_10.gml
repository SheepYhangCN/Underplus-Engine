...
_dialog.text="{font 3}{scale 1}{voice VOICE.SPONGE}{sponge_face 3}You caused all of these,{sleep 15}&isn't it?"
}else if(global.language=LANGUAGE.SCHINESE){
_dialog.text="{font 3}{scale 1}{voice VOICE.SPONGE}{sponge_face 3}是你造成的一切, {sleep 15}&不是吗? "
}