...
_dialog.text="{font 3}{scale 1}{voice 3}{utcsans_face 3}a lot of times y wonder,{sleep 15}&whether what we have done&is valuable or not.{pause}{clear}{utcsans_face 0}the light in our hearts,{sleep 15}&has dragged us into a new&sorrow."
