...
Blaster_Create_Advanced(x_start,y_start,x_target,y_target,0,angle,0.6,2,0,20,spr_blaster,10,10)
_dir-=6
...
Blaster_Create_Advanced(x_start1,y_start1,x_target1,y_target1,0,angle1,0.6,2,0,20,spr_blaster,10,10)
_dir1-=6
alarm[5] = 3
