...
if(global.language=LANGUAGE.ENGLISH){inst.text="{voice VOICE.ASRIEL}{warma_face 3}{speed 3}If you can,{sleep 15}{warma_face 0}&can you just back?"}
if(global.language=LANGUAGE.SCHINESE){inst.text="{voice VOICE.ASRIEL}{warma_face 3}{speed 5}如果可以的话{sleep 15}{warma_face 0}&回来吧, 好吗?"}
/*var inst=instance_create_depth(420,120,0,battle_dialog_enemy)
