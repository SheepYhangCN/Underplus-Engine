...
if(global.language=LANGUAGE.ENGLISH){
	Dialog_Add("* You want to eat Honyaradoh.{sleep 20}&* He gave you a slap and ran&  away.{sleep 20}{clear}* You got a cat claw mark on your&  face.{pause}{clear}* You recovered 1+5+7+4+9 HP.")
