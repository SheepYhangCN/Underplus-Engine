...
dialog1.text="{font 1}{scale 2}{speed 1}{instant true}"+GAME_NAME+" By "+GAME_AUTHOR+"&UNDERTALE Engine By 糖萌芦&Underplus Engine By 憨憨羊の宇航鸽鸽&GameMaker Studio 2 By YoYoGames&&蓝魂和板子和骨头By 1个渣渣&Gaster冲击波 By Schizoid_Doge&星空背景着色器By Kali&商店By不会起名的一杯猹&开发者控制台By DaveTech&移动端操作By Darknslim"
