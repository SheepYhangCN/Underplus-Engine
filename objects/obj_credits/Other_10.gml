...
dialog1.text="{font 1}{scale 2}{speed 1}{instant true}Fonts used&Determination Sans/Mono,&Mars Needs Cunnilingus,Papyrus&By Toby Fox&SimSun By Beijing ZHONG YI ZHONG Biao&Electronic INFORMATION Technology Co.&方正少儿GBK By 方正字库&迷你简卡通 Source Unknown&Comic Sans, Dotumche&By Microsoft&GNU Unifont By Roman Czyborra"
dialog3=instance_create_depth(450,20,0,text_typer)
dialog3.text="{scale 2}{instant true}<Page "+string(page+1)+"/4>"
}else if(global.language=LANGUAGE.SCHINESE){
dialog1=instance_create_depth(70,60,0,text_typer)
dialog1.text="{font 1}{scale 2}{speed 1}{instant true}字体使用&Determination Sans/Mono,&Mars Needs Cunnilingus,Papyrus&By Toby Fox&宋体By 北京中易中标电子信息技术有限公司&方正少儿GBK By 方正字库&迷你简卡通 来源未知&Comic Sans, Dotumche&By Microsoft&GNU Unifont By Roman Czyborra"
dialog3=instance_create_depth(480,20,0,text_typer)
