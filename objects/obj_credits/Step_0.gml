...
dialog1.text="{font 1}{scale 2}{speed 1}{instant true}Underplus Engine By 憨憨羊の宇航鸽鸽&UNDERTALE Engine By 糖萌芦&GameMaker By YoYoGames&&蓝魂和板子和骨头By 1个渣渣&Gaster冲击波 By Schizoid_Doge&星空背景着色器By Kali&商店By不会起名的一杯猹 \\& 1个渣渣&开发者控制台By DaveTech&移动端操作By Darknslim&水画面效果By 复读鸭"
...
if(global.language=0){
dialog1=instance_create_depth(70,70,0,text_typer)
dialog1.text="{font 1}{scale 2}{speed 1}{instant true}Special Thanks&Cxx, YuanSaTion, Ptfk"
dialog3=instance_create_depth(450,20,0,text_typer)
