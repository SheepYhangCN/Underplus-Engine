...
dialog1.text="{font 1}{scale 2}{speed 1}{instant true}YH!Undertale Games By 憨憨羊の宇航鸽鸽&&UNDERTALE Engine By 糖萌芦&GameMaker Studio 2 By YoYoGames&&蓝魂和板子和骨头By 1个渣渣&星空背景着色器 By Kali&动态血条By Panthervention&商店By不会起名的一杯猹&开发者控制台By DaveTech&移动端操作By Darknslim"
...
if(global.language=0){
dialog1=instance_create_depth(60,70,0,text_typer)
dialog1.text="{font 1}{scale 2}{speed 1}{instant true}Extra-Board and Cover-Board By&OneZhaZha, Siki, 穹c啋f汾, jkjkil4, &奇迹丶零, 一只鸽子_Official, Sanesss"
dialog3=instance_create_depth(450,20,0,text_typer)
dialog3.text="{scale 2}{instant true}<Page "+string(page+1)+"/3{color `gray`}>"
}else if(global.language=1){
dialog1=instance_create_depth(70,60,0,text_typer)
dialog1.text="{font 1}{scale 2}{speed 1}{instant true}异形框By&1个渣渣、Siki、穹c啋f汾、jkjkil4、&奇迹丶零、一只鸽子_Official、Sanesss"
dialog3=instance_create_depth(480,20,0,text_typer)
