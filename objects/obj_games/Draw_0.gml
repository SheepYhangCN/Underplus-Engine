...
if(global.language=LANGUAGE.SCHINESE){draw_text_scribble(320,435,"[font_chinese][scale,2]使用上下方向键切换游戏")}
if(global.language=LANGUAGE.SCHINESE){game="[font_chinese]小游戏"}
if(phase=0){
draw_sprite_ext(spr_blaster,0,320-3,300-7,3,3,-90,c_white,1)
if(global.language=LANGUAGE.ENGLISH){game+=" | 3 Minute GB Fan Fight"}
if(global.language=LANGUAGE.SCHINESE){game+="[font_dialog] | 3[font_chinese]分钟大风车耐力战"}
}
break
case 0:
if(global.language=LANGUAGE.ENGLISH){draw_text_transformed(320,430,"Use Up and Down arrow keys to switch phase",2,2,0)}
if(global.language=LANGUAGE.SCHINESE){draw_text_scribble(320,435,"[font_chinese][scale,2]使用上下方向键切换阶段")}
if(global.language=LANGUAGE.ENGLISH){game="Undertale : Snowdin Encounter | Sans Fight"}
if(global.language=LANGUAGE.SCHINESE){game="[font_dialog]Undertale:[font_chinese]雪镇之遇[font_dialog] | Sans[font_chinese]战"}
switch phase{
case 0:
...
if(global.language=LANGUAGE.SCHINESE){game+="[font_dialog] | [font_chinese]开头"}
break
case 1:
...
if(global.language=LANGUAGE.SCHINESE){game+="[font_dialog] | [font_chinese]第[font_dialog]1[font_chinese]阶段"}
break
case 2:
//draw_sprite_ext(spr_battle_bg_snowdin,0,102+6,108+6,418/639,198/253,0,c_white,1)
draw_sprite_ext(spr_sans_leg,0,325-2,220+53,2,2,0,c_white,1)
...
if(global.language=LANGUAGE.SCHINESE){game+="[font_dialog] | [font_chinese]第[font_dialog]2[font_chinese]阶段"}
break
}
break
case 1:
...
if(global.language=LANGUAGE.SCHINESE){game="[font_dialog]Anya Forger[font_chinese]战"}
}
if(phase=1){
...
if(global.language=LANGUAGE.SCHINESE){game="[font_chinese]阿尼亚觉得她是[font_dialog]dt2"}
}
break
case 2:
if(global.language=LANGUAGE.ENGLISH){draw_text_transformed(320,430,"Use Up and Down arrow keys to switch phase",2,2,0)}
...
if(global.language=LANGUAGE.SCHINESE){game="[font_dialog][[[font_chinese]已弃坑[font_dialog]][font_chinese]原版[font_dialog]Sans[font_chinese]战重制"}
switch phase{
case 0:
...
if(global.language=LANGUAGE.SCHINESE){game+="[font_dialog] | [font_chinese]长廊"}
break
case 1:
draw_sprite_ext(spr_sans_leg,0,325-2,220+53,2,2,0,c_white,1)
draw_sprite_ext(spr_sans_body,0,325-3,220+8,2,2,0,c_white,1)
...
if(global.language=LANGUAGE.SCHINESE){game="[font_dialog]Undertale: Candid | Sans[font_chinese]战"}
break
case 4:
...
if(global.language=LANGUAGE.SCHINESE){game="[font_dialog][[[font_chinese]已弃坑[font_dialog]][font_chinese]星空传说[font_dialog]StarryTale | Sans[font_chinese]战"}
break
case 5:
if(global.language=LANGUAGE.ENGLISH){draw_text_transformed(320,430,"Use Up and Down arrow keys to switch phase",2,2,0)}
if(global.language=LANGUAGE.SCHINESE){draw_text_scribble(320,435,"[font_chinese][scale,2]使用上下方向键切换阶段")}
...
if(global.language=LANGUAGE.SCHINESE){game="[font_dialog][[[font_chinese]已弃坑[font_dialog]]Undershift | Sans[font_chinese]战"}
break
}
if(global.language=LANGUAGE.ENGLISH){
...
if(global.language=LANGUAGE.SCHINESE){draw_text_scribble(320,405,"[scale,2][font_chinese]按下[font_dialog]Z[font_chinese]或[font_dialog]Enter[font_chinese]来开始")}
}else{
