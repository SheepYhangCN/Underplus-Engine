...
case 2:
draw_text_transformed(320,430,"Use Up and Down arrow keys to switch phase",2,2,0)
game="[Cancelled] Classic! Sans Fight Remake"
switch phase{
case 0:
...
game="[Too Embarassing] Undertale: Candid | Sans Fight"
break
case 4:
...
case 2:
draw_text_scribble(320,435,"[font_chinese][scale,2]使用上下方向键切换阶段")
game="[font_dialog][[[font_chinese]已弃坑[font_dialog]][font_chinese]原版[font_dialog]Sans[font_chinese]战重制"
switch phase{
case 0:
draw_sprite_ext(spr_bg_sanscorridor_full_cut,0,320-3,220-7,418/480,198/240,0,c_white,1)
...
draw_sprite_ext(spr_utcsans_body,0,325-3,220-2,2,2,0,c_white,1)
draw_sprite_ext(spr_utcsans_face,0,325-3,220-60,2,2,0,c_white,1)
game="[font_dialog][[[font_chinese]黑历史[font_dialog]][font_chinese][font_dialog]Undertale: Candid | Sans[font_chinese]战"
break
case 4:
draw_sprite_ext(spr_starry_sans_legs,0,320,220+60,2,2,0,c_white,1)
draw_sprite_ext(spr_starry_sans_body,0,320,220+10,2,2,0,c_white,1)
