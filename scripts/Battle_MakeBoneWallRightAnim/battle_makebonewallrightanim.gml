...
///@arg 骨头出场动画效果
///@arg *骨头出场延迟
function Battle_MakeBoneWallRightAnim(){
var bone_x = argument[0];
var bone_bottom_y = argument[1];
...
var num = 0;
repeat bone_count{
bone1=Battle_MakeBoneH(bone_x,bone_bottom_y-bones_between_length*num,0,0,0,bone_color,0,0,0,1);
