...
///@arg 骨头出场动画效果
///@arg *骨头出场延迟
function Battle_MakeBoneWallTopAnim(){
var bone_left_x = argument[0];
...
var num = 0;
repeat bone_count{
bone1=Battle_MakeBoneV(bone_left_x+bones_between_length*num,bone_y,0,0,0,bone_color,0,0,0,1);
