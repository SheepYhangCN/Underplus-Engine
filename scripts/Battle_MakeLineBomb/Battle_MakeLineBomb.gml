///@arg x,y,*angle,*width,*crossing,*type,*xscale,*yscale,*spawn_time,*wait_time,*stay_time,*leave_time,*obj,*spr
function Battle_MakeLineBomb(){
var OBJ=battle_bullet_line_bomb
if(argument_count>12){OBJ=argument[12]}
...
if(argument_count>13){inst.sprite_index=argument[13]}
return inst
}