function Encounter_Custom() {
	...
	Encounter_Set(BATTLE.UTSE_SANS,-1,battle_enemy_snowsans,-1,"* White dust are falling with&  snowflakes.")
	...
	Encounter_Set(BATTLE.SANS_REMAKE,-1,battle_enemy_sans,-1,"* You feel like you're going to&  have a \"bone\" time.")
	...
	Encounter_Set(BATTLE.UTSE_SANS,-1,battle_enemy_snowsans,-1,"* 雪白的尘埃伴随着雪花飘落。")
	...
	Encounter_Set(BATTLE.ANYA_DT2,-1,battle_enemy_anya_dt2,-1,"")
	Encounter_Set(BATTLE.SANS_REMAKE,-1,battle_enemy_sans,-1,"* 你感觉你要吃“骨”头了。")
